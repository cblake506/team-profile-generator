...
const inquireManager = () => {
    ...
    .then((answers) => {
        return newManager = new Manager(answers.name, answers.id, answers.email, answers.officeNumber);
...
const inquireEngineer = () => {
    ...
    .then((answers) => {
        return newEngineer = new Engineer(answers.name, answers.id, answers.email, answers.github);
    });
}
...
const inquireIntern = () => {
    ...
    .then((answers) => {
        return newIntern = new Intern(answers.name, answers.id, answers.email, answers.school);
    });
}
